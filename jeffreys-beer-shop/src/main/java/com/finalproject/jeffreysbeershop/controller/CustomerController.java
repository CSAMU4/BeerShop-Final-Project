...
@OpenAPIDefinition(info = @Info(title = "Jeffrey's Beer Shop Customer Service"), servers = {
  ...
  @Operation(
      ...
      parameters = {
          @Parameter(
              ...
              required = false, 
              description = "The customerPK (i.e., '21')"), 
          @Parameter(
              name = "customerId",
              allowEmptyValue = false,
              required = false,
  ...
  @Operation(
      ...
      parameters = {
          ...
          @Parameter(
              ...
              allowEmptyValue = false,
              required = false,
              description = "The first name (i.e., 'Nicholas')"),
          @Parameter(
              name = "lastName",
              allowEmptyValue = false,
              required = false,
              description = "The last name (i.e., 'Ramnauth')"),
          @Parameter(
              name = "phone",
              allowEmptyValue = false,
              required = false,
              description = "The phone number (i.e., '7183846903')")
      }
  )
