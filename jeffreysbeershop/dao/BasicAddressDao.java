...
public class BasicAddressDao implements AddressDao {
  ...
  public Optional<Address> createAddress(String customerId, String billingAddress,
    ...
    log.info("DAO: customerId={}, billingAddress={}, shippingAddress={}", customerId,
   ...
   //@formatter:on
    ...
    return Optional.ofNullable(
        Address.builder().billingAddress(billingAddress).shippingAddress(shippingAddress).build());
  }

  @Override
  public Optional<Address> updateAddress(Long addressPK, String customerId, String billingAddress,
      String shippingAddress) {
    log.info("DAO: addressPK={}, customerId={}, billingAddress={}, shippingAddress={}", addressPK,
    ...
    jdbcTemplate.update(sql, params);
    return Optional.ofNullable(Address.builder().addressPK(addressPK).billingAddress(billingAddress)
