...
public class BasicCustomerDao implements CustomerDao {
    ...
    return jdbcTemplate.query(sql, params, new RowMapper<>() {
      ...
      public Customers mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        return Customers.builder()
            .customersPK(rs.getLong("customer_pk"))
  ...
  public Optional<Customers> createCustomers(String customerId, String firstName, String lastName,
      String phone) {
    log.info("DAO: customerId={}, firstName={}, lastName={}, phone={}", customerId, firstName,
        lastName, phone);
 ...
 //@formatter:on
    ...
    return Optional.ofNullable(Customers.builder().customerId(customerId).firstName(firstName)
  ...
  public Optional<Customers> updateCustomers(String customerId, String firstName, String lastName,
    ...
    log.info(
        "DAO: customerId={}, firstName={}, lastName={}, phone={}, newFirstName={}, "
            + "newLastName={}, newPhone={}",
        customerId, firstName, lastName, phone, newFirstName, newLastName, newPhone);
    ...
    jdbcTemplate.update(sql, params);
    return Optional.ofNullable(Customers.builder().customerId(customerId).firstName(newFirstName)
        .lastName(newLastName).phone(newPhone).build());
  }
}
